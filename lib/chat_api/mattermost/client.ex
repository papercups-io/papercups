defmodule ChatApi.Mattermost.Client do
  ...
  def client(%MattermostAuthorization{access_token: token, mattermost_url: url}) do
    middleware = [
  ...
  @spec send_message(map(), MattermostAuthorization.t()) :: Tesla.Env.result() | {:ok, nil}
  ...
  @spec get_message(binary(), MattermostAuthorization.t()) :: {:ok, nil} | Tesla.Env.result()
  ...
  @spec list_channels(MattermostAuthorization.t()) :: {:ok, nil} | Tesla.Env.result()
  ...
  @spec get_channel(binary(), MattermostAuthorization.t()) :: {:ok, nil} | Tesla.Env.result()
  ...
  @spec list_users(MattermostAuthorization.t()) :: {:ok, nil} | Tesla.Env.result()
  ...
  @spec get_user(binary(), MattermostAuthorization.t()) :: {:ok, nil} | Tesla.Env.result()
  ...
  @spec list_teams(MattermostAuthorization.t()) :: {:ok, nil} | Tesla.Env.result()
  ...
  @spec get_team(binary(), MattermostAuthorization.t()) :: {:ok, nil} | Tesla.Env.result()
