defmodule ChatApiWeb.Router do
  ...
  scope "/api", ChatApiWeb do
    ...
    get("/discord/oauth", DiscordController, :oauth)
    get("/discord/authorization", DiscordController, :authorization)
    delete("/discord/authorizations/:id", DiscordController, :delete)
