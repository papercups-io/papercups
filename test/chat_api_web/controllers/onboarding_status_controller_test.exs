defmodule ChatApiWeb.OnboardingStatusControllerTest do
  ...
  describe "index" do
    test "configured_profile is true if display_name, full_name, or profile_photo_url has been set",
    ...
    test "configured_storytime is true if the account has browser sessions", %{
    ...
    test "installed_chat_widget is true if the widget settings host exists and isn't papercups or localhost",
    ...
    test "invited_teammates is true if there are more than 1 active users for the account",
         %{authed_conn: authed_conn, account: account} do
    ...
    test "upgraded_subscription is true if subscription is not starter", %{
      authed_conn: authed_conn,
      account: account
    } do
